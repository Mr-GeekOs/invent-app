			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li><a href="categories.php">Liste modèle</a></li>
					</ul>
								...
								<table class="table table-hover table-nomargin table-bordered">
									...
									<tbody class="loaded">
                                    	...
                                    	<?php
											...
											$query = mysql_query('select * from model order by id_model desc');
											while ($result = mysql_fetch_array($query))
											{
													$famille = mysql_query('select nom from marque where id_marque ='.$result['id_marque'].' ');
													$fams = mysql_fetch_array($famille);
													$fam = $fams['nom'];
												echo "
													<tr>
														<td>".stripslashes($result['nom'])."</td>
														<td>".stripslashes($fam)."</td>
														<td>
															<a href=\"upmdl.php?d=".$result['id_model']."\" class=\"btn\" rel=\"tooltip\" title=\"Modifier\"><i class=\"fa fa-edit\"></i></a>
															<a href=\"modules/model/action.php?d=".$result['id_model']."&action=delmdl\" class=\"btn\" rel=\"tooltip\" title=\"Supprimer\"><i class=\"fa fa-times\"></i></a>
														</td>
													</tr>
