			...
			<div class="container-fluid">
					...
					<div class="pull-right">
						...
						<ul class="stats">
							<li class='satgreen'>
								...
								<div class="details">
									<a href="addpai.php" style="color: white">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li><a href="#">Liste méthode de paiement</a></li>
					</ul>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box box-color box-bordered">
							<div class="box-title">
								<h3>Liste méthode de paiement</h3>
							</div>
								...
								<table class="table table-hover table-nomargin table-bordered">
									...
									<tbody class="loaded">
                                    	...
                                    	<?php
											...
											$query = mysql_query('select * from paiement order by nom asc');
											while ($result = mysql_fetch_array($query))
											{
												...
												echo "
													<tr>
														...
														<td>
															<a href=\"uppai.php?d=".$result['id_pai']."\" class=\"btn\" rel=\"tooltip\" title=\"Modifier\"><i class=\"fa fa-edit\"></i></a>
															<a onclick=\"return(confirm('Etes-vous sûr de vouloir supprimer cette entree?'));\" href=\"modules/paiement/action.php?d=".$result['id_pai']."&action=delpai\" class=\"btn\" rel=\"tooltip\" title=\"Supprimer\"><i class=\"fa fa-times\"></i></a>
														</td>
													</tr>
