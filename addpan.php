			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
                        ...
                        <li><a href="addcat.php">Ajout Type de Panne</a></li>
					</ul>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title"><h3><i class="fa fa-check"></i>Ajout Type de Panne</h3></div>
							<div class="box-content">
								<form action="modules/panne/action.php" method="POST" class='form-horizontal form-validate' id="bb" enctype="multipart/form-data">
									<input type="hidden" name="action" value="addpan" >
