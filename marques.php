					...
					<div class="pull-right">
						...
						<ul class="stats">
							<li class='satgreen'>
								...
								<div class="details">
									<a href="addmark.php" style="color: white">
								...
								<table class="table table-hover table-nomargin table-bordered">
									...
									<tbody class="loaded">
                                    	...
                                    	<?php
											...
											$query = mysql_query('select * from marque order by id_marque desc');
											while ($result = mysql_fetch_array($query))
											{
												echo "
													<tr>
														...
														<td>
															<a href=\"upmark.php?d=".$result['id_marque']."\" class=\"btn\" rel=\"tooltip\" title=\"Modifier\"><i class=\"fa fa-edit\"></i></a>
															<a onclick=\"return(confirm('Etes-vous sûr de vouloir supprimer cette entree?'));\" href=\"modules/marque/action.php?d=".$result['id_marque']."&action=delmark\" class=\"btn\" rel=\"tooltip\" title=\"Supprimer\"><i class=\"fa fa-times\"></i></a>
														</td>
													</tr>
