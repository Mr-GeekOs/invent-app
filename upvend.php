		...
		<div id="main">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title"><h3><i class="fa fa-check"></i>MAJ Vendeur</h3></div>
							<div class="box-content">
								<form action="modules/vendeur/action.php" method="POST" class='form-horizontal form-validate' id="bb">
									<input type="hidden" name="action" value="upvend" >
											...
											<?php
                                                ...
                                                $query = mysql_query('select * from vendeur where id_vendeur='.$d.' ');
