		...
		<div id="main">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title"><h3><i class="fa fa-check"></i>MAJ Coleur</h3></div>
							<div class="box-content">
								<form action="modules/coleurs/action.php" method="POST" class='form-horizontal form-validate' id="bb">
									<input type="hidden" name="action" value="upcol" >
                                    
											<?php
                                                include_once('modules/general/parametre-db.inc.php');
												$d = (int) abs($_GET['d']);
                                                
                                                $query = mysql_query('select * from couleur where id_col='.$d.' ');
