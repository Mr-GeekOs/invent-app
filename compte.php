								...
								<table class="table table-hover table-nomargin table-bordered">
									...
									<tbody class="loaded">
                                    	...
                                    	<?php
											...
											{
												if ($result['acces']==1) {$dels = "";}
												else {$dels="<a onclick=\"return(confirm('Etes-vous sûr de vouloir supprimer cette entree?'));\" href=\"modules/compte/action.php?d=".$result['id_adm']."&action=delcompte\" class=\"btn\" rel=\"tooltip\" title=\"Supprimer\"><i class=\"fa fa-times\"></i></a>";}
													
												echo "
													<tr>
														<td>".stripslashes($result['nom'])."</td>
														<td>".stripslashes($result['email'])."</td>
														<td>
															<a href=\"upcompte.php?d=".$result['id_adm']."\" class=\"btn\" rel=\"tooltip\" title=\"Modifier\"><i class=\"fa fa-edit\"></i></a>
															".$dels."
														</td>
													</tr>
