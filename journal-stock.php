								...
								<table class="table table-hover table-nomargin table-bordered">
									...
									<tbody class="update" id="insert_search">
                                    	...
                                    	<?php
											...
											$query = mysql_query('select * from produits order by id_prod desc limit 200');
											while ($result = mysql_fetch_array($query))
											{
													...
													if ($result['dispo']==1) { $dispo ="<span class=\"label label-satgreen\">En Stock</span>"; }
													else if ($result['dispo']==0 or $result['dispo']==2) { $dispo ="<span class=\"label label-lightred\">Sur Commande</span>"; }
													else { $dispo ="<span class=\"label label-lightgari\">Nous consulter</span>"; }
