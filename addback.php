			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
                        ...
                        <li><a href="addback.php">Ajout Background</a></li>
					</ul>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title"><h3><i class="fa fa-check"></i>Ajout Background</h3></div>
								...
								<form action="modules/promo/action.php" method="POST" class='form-horizontal form-validate' id="bb" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<span class="help-block">Taille 1600 / 800 px</span>
										</div>
									</div>
