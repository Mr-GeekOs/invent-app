			...
			<div class="container-fluid">
					...
					<div class="pull-right">
						...
						<ul class="stats">
							<li class='satgreen'>
								...
								<div class="details">
									<a href="addcoler.php" style="color: white">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li><a href="categories.php">Liste coleurs</a></li>
					</ul>
								...
								<table class="table table-hover table-nomargin table-bordered">
									...
									<tbody class="loaded">
                                    	...
                                    	<?php
											...
											$query = mysql_query('select * from couleur order by id_col desc');
											while ($result = mysql_fetch_array($query))
											{
												echo "
													<tr>
														...
														<td>
															<a href=\"upcol.php?d=".$result['id_col']."\" class=\"btn\" rel=\"tooltip\" title=\"Modifier\"><i class=\"fa fa-edit\"></i></a>
															<a onclick=\"return(confirm('Etes-vous sûr de vouloir supprimer cette entree?'));\" href=\"modules/coleurs/action.php?d=".$result['id_col']."&action=delcol\" class=\"btn\" rel=\"tooltip\" title=\"Supprimer\"><i class=\"fa fa-times\"></i></a>
														</td>
													</tr>
