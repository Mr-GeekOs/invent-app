				...
				<div class="page-header">
					...
					<div class="pull-right">
						...
						<ul class="stats">
								...
								<div class="details">
									<a href="addvend.php" style="color: white">
								...
								<table class="table table-hover table-nomargin table-bordered">
									...
									<tbody class="loaded">
                                    	...
                                    	<?php
											...
											$query = mysql_query('select * from vendeur order by id_vendeur desc');
											while ($result = mysql_fetch_array($query))
											{
												...
												echo "
													<tr>
														...
														<td>
															<a href=\"upvend.php?d=".$result['id_vendeur']."\" class=\"btn\" rel=\"tooltip\" title=\"Modifier\"><i class=\"fa fa-edit\"></i></a>
															<a onclick=\"return(confirm('Etes-vous sûr de vouloir supprimer cette entree?'));\" href=\"modules/vendeur/action.php?d=".$result['id_vendeur']."&action=delvend\" class=\"btn\" rel=\"tooltip\" title=\"Supprimer\"><i class=\"fa fa-times\"></i></a>
														</td>
													</tr>
