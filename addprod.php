			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
                        ...
                        <li><a href="addcat.php">Ajout produit</a></li>
					</ul>
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title"><h3><i class="fa fa-check"></i>Ajout produit</h3></div>
							<div class="box-content">
								<form action="modules/produits/action.php" method="POST" class='form-horizontal form-validate' id="bb" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label for="select" class="control-label col-sm-2">Catégorie</label>
										<div class="col-sm-10">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											...
											<?php
                                                ...
                                                {
													echo "<option value=\"".$result3['id_col']."\">".stripslashes($result3['nom'])."</option>";
                                                }
                                            ?>
                                            </select>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="prixachat" id="textfield" class="form-control" data-rule-required="false" >
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="prixvente" id="textfield" class="form-control" data-rule-required="false" >
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="qtmin" id="textfield" class="form-control" data-rule-required="false" >
										</div>
									</div>
