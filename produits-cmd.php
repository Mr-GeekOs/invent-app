			...
			<div class="container-fluid">
					...
					<div class="pull-right">
						...
						<ul class="stats">
							...
							<li class='lightred'>
								...
								<div class="details">
                                <a href="cmd_pdf.php">
									<span class="big">Telecharger le PDF</span>
									<span>des produits sur commande</span>
								</a>
                                </div>
							</li>
						</ul>
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li><a href="produits-cmd.php">Liste produits sur commande</a></li>
					</ul>
								...
								<table class="table table-hover table-nomargin table-bordered">
									...
									<tbody>
                                    	...
                                    	<?php
											...
											$query = mysql_query('select * from produits where dispo=2 order by id_prod desc');
											while ($result = mysql_fetch_array($query))
											{
													...
													if ($result['valid']==1) { $act ="<span class=\"label label-satgreen\">Active</span>"; }
