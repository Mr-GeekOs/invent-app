		...
		<div id="main">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title"><h3><i class="fa fa-check"></i>Modifier client</h3></div>
							<div class="box-content">
								<form action="modules/client/action.php" method="POST" class='form-horizontal form-validate' id="bb" enctype="multipart/form-data">
											<?php
                                                ...
                                                $query = mysql_query('select * from client where id_client='.$d.' ');
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="tel" value="<?php echo $result['tel']; ?>" id="textfield" class="form-control" data-rule-required="false" data-rule-minlength="0">
										</div>
									</div>
