...
$( document ).ready(function() {
	...
	$(".search_button").click(function() {
		...
		var dataString = 'search_word='+ search_word +'&marque='+ marque +'&cat='+ cat+'&rep=no';
				...
				<div class="row">
                  ...
                  <?php
                        ...
                        $fam = $fams['nom'];
												...
												$marks2 = @$result['marque'];
												$famille2 = @mysql_query('select nom from marque where id_marque ='.$marks2.' ');
												$fams2 = @mysql_fetch_array($famille2);
												$fam2 = $fams2['nom'];

												$prods2 = $result['id_prod'];
												$entreestock = @mysql_query("select sum(qt) from entreestock where id_prod=".$prods2." ");
