			...
			<div class="container-fluid">
				...
				<div class="breadcrumbs">
					<ul>
						...
						<li><a href="categories.php">Liste Type de panne</a></li>
					</ul>
								...
								<table class="table table-hover table-nomargin table-bordered">
									...
									<tbody class="loaded">
                                    	...
                                    	<?php
											...
											$query = mysql_query('select * from type_pan order by nom asc');
											while ($result = mysql_fetch_array($query))
											{
												if ($result['categorie']==1) {$fam ="Soft";}
												else {$fam ="Hard";}
												echo "
													<tr>
														...
														<td>".$fam."</td>
														<td>
															<a href=\"uppan.php?d=".$result['id_type']."\" class=\"btn\" rel=\"tooltip\" title=\"Modifier\"><i class=\"fa fa-edit\"></i></a>
															<a href=\"modules/panne/action.php?d=".$result['id_type']."&action=delpan\" class=\"btn\" rel=\"tooltip\" title=\"Supprimer\"><i class=\"fa fa-times\"></i></a>
														</td>
													</tr>
