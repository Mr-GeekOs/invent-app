		...
		<div id="main">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title"><h3><i class="fa fa-check"></i>Entrée Stock</h3></div>
							<div class="box-content">
								<form action="modules/stock/action.php" method="POST" class='form-horizontal form-validate' id="bb" enctype="multipart/form-data">
											<?php
									...
									<div class="form-group">
										<label for="textfield" class="control-label col-sm-2">QT</label>
										<div class="col-sm-10">
											<input type="text" name="qt" id="textfield" class="form-control" data-rule-required="false" >
										</div>
									</div>
