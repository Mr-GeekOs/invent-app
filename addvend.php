		...
		<div id="main">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-sm-12">
						<div class="box">
							<div class="box-title"><h3><i class="fa fa-check"></i>Ajout vendeur</h3></div>
							<div class="box-content">
								<form action="modules/vendeur/action.php" method="POST" class='form-horizontal form-validate' id="bb" enctype="multipart/form-data">
									<input type="hidden" name="action" value="addvend" >
